...
using Dswi_Proyecto_Topico.Filters;
    ...
    public class AdminController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            var viewModel = new DashboardAdminViewModel
            {
                ...
                AlertasCriticas = await _alertaService.ObtenerPorRolAsync("Administrador"),
        ...
        {
            // 1. Validar campos principales (ProveedorId, NumeroComprobante, etc.)
            // Si algún campo principal falla, ModelState.IsValid será false
            if (!ModelState.IsValid)
            {
                // Si hay errores de validación de campos principales, recargamos las listas
                // y regresamos la vista para que el usuario corrija los errores en rojo.
